...
public class DateBean3 {
    ...
    public boolean isRenyi = false;
    public boolean isWuwei = false;
    public boolean isXiaJiang = false;
    public boolean isSha = false;

    public String error ;
    public ArrayList<Integer> xiajiangNumber = new ArrayList<>();
    ...
    public static JSONArray DateBean2ArrayListToJson( ArrayList<DateBean3>  list) {
        JSONArray array = new JSONArray();
        if(list.size() > 0) {
            for(DateBean3 d : list) {
                array.put(d.toJson());
            }
        }
        return array;
