...
public class SingleStrDealBean {
    ...
    public ArrayList<Integer> heNumber =new ArrayList<Integer>();
    ...
    public String toString() {
        ...
        builder.append("\nhaveGroup = "+haveGroup+" haveCount="+haveCount+" haveLoacl="+haveLoacl+" heNumber="+heNumber.toString()+" isPai="+isPai+" isHe"+isHe);
